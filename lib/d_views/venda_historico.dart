...
class VendaHistorico extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      appBar: const CustomHeader(pageTitle: 'Histórico de Vendas', showBackButton: true),
            ...
            itemBuilder: (context, index) {
              ...
              return Dismissible(
                  ...
                  return await showDialog(
                    ...
                    builder: (BuildContext context) {
                      return AlertDialog(
                        ...
                        content: Text("Tem certeza que deseja excluir a venda para o cliente \"${venda.cliente}\"?"),
                        actions: <Widget>[
                          TextButton(
                ...
                onDismissed: (direction) {
                  Provider.of<VendaController>(context, listen: false).deletarVenda(venda.id);
                  ScaffoldMessenger.of(context).showSnackBar(
                    SnackBar(content: Text('Venda para "${venda.cliente}" excluída.')),
                  );
                },
                child: Card(
                  elevation: 1,
                  ...
                  child: ListTile(
                    ...
                    title: Text(venda.cliente, style: const TextStyle(fontWeight: FontWeight.bold)),
                    ...
                    onTap: () {
                      Navigator.pushNamed(context, VendaComprovante.routeName, arguments: venda);
                    },
                  ),
                ),
              );
